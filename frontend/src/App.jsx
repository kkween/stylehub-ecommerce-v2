...
const Footer = () => (
  ...
  <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center md:text-left">
      ...
      <div className="border-t border-purple-200 mt-8 pt-8 flex flex-col items-center justify-center text-center">
        <p className="text-gray-600 text-sm mb-4">&copy; 2025 StyleHub. All rights reserved.</p>
